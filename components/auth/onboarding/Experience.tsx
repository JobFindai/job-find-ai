...
export function Experience({ value }: { value: string }) {
  return (
    <PreviewFormItem value={value} title="Experience">
      <p className="bg-gray-100 rounded-lg px-3 py-5 leading-normal">
        Full Stack Engineer – Flickmart (Nov 2024 – Present) Built a
        personalized recommendation engine that increased product relevance and
        boosted engagement by 18–25%. Engineered a data ingestion pipeline
